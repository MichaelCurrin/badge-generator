...
describe("#markdownImage", () => {
  it("returns a valid markdown image", () => {
    expect(
      markdownImage('Alt text', 'foo.md'))
      .toEqual('![Alt text](foo.md)');

    expect(
      markdownImage('Example', 'https://example.com'))
      .toEqual('![Example](https://example.com)');
  });

  it("returns a valid markdown image with hover text", () => {
    expect(
      markdownImage('Alt text', 'foo.md', "My hover text"))
      .toEqual('![Alt text](foo.md "My hover text")');
