...
// a certain way so it is still worth testing the whole function. Though, things to be refactored
// for more functions/methods to just return data and then build them on the frontend, but then you
// still need to test the frontend part, or make sure the markdown link functions get tested
// standalone with all badges used on the frontend.
